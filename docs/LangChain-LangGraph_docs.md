...
- [Changelog](https://docs.langchain.com/oss/javascript/releases/changelog.md): Log of updates and improvements to LangChain JavaScript/TypeScript
...
- [Changelog](https://docs.langchain.com/oss/python/releases/changelog.md): Log of updates and improvements to LangChain Python
